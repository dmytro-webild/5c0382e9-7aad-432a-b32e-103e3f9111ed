  ...
  <div id="hero" data-section="hero">
      ...
      mediaItems={[
        ...
        },
        {
          ...
          imageAlt: "Elegant Restaurant Table Setting Service for Reception",
        },
        {
          ...
          imageAlt: "front view dark square plates with golden fork and knife on dark desk cutlery restaurant lunch color plate tea drink",
        },
      ]}
      ...
      features={[
        {
          ...
          description: "Sous-vide perfection combined with traditional roasting techniques for maximum depth.",
          phoneOne: {
        ...
        },
        {
          ...
          description: "Our expert sommelier selects the finest vintages to elevate every flavor profile.",
          phoneOne: {
            imageSrc: "http://img.b2bpic.net/free-photo/still-life-wine-carafe-table_23-2149631755.jpg",
          },
          phoneTwo: {
        ...
        {
          title: "Sensory Plating",
          description: "A 3D approach to visual food design that delights both the eye and the palate.",
          phoneOne: {
          ...
          imageSrc: "http://img.b2bpic.net/free-vector/chef-hat-labels-template-set_1284-52227.jpg",
          imageAlt: "professional chef working in kitchen",
        },
      ]}
  ...
  <div id="products" data-section="products">
      ...
      products={[
        ...
        },
        {
          ...
          price: "$45",
          variant: "Pasta",
          imageSrc: "http://img.b2bpic.net/free-photo/top-view-fresh-red-tomatoes-dark-background-salad-meal-health-food_140725-86105.jpg",
        },
        {
          id: "p3",
          ...
          price: "$52",
          variant: "Seafood",
          imageSrc: "http://img.b2bpic.net/free-photo/seabass-barramundi-fish-meat-steak_74190-5984.jpg",
        },
        {
          id: "p4",
        ...
        },
        {
          ...
          price: "$32",
          variant: "Vegetarian",
          imageSrc: "http://img.b2bpic.net/free-photo/spicy-seafood-salad_1203-8916.jpg",
        },
        {
          id: "p6",
          name: "Lobster Bisque",
      ...
      testimonials={[
        {
          ...
          quote: "The 3D plating concept is absolutely breathtaking. Simply the best meal I've had all year.",
          tag: "Food Critic",
        ...
        },
        {
          ...
          quote: "A truly refined experience. The sommelier recommendations were flawless and perfectly complemented every course.",
          tag: "Regular",
        ...
        },
        {
          ...
          quote: "We celebrated our anniversary and everything was executed to perfection. Highly recommended for special occasions.",
          tag: "Guest",
        ...
        },
        {
          ...
          quote: "A masterclass in modern dining. Every bite was an exploration of texture and flavor.",
          tag: "Blogger",
        ...
        },
        {
          ...
          date: "Jul 2024",
          title: "Hidden Gem",
          quote: "Finally, a restaurant that understands the balance between style and substance. Truly remarkable.",
          tag: "Guest",
          avatarSrc: "http://img.b2bpic.net/free-photo/black-american-couple-date-meeting-drink-wine-restaurant_613910-7260.jpg",
  ...
  <div id="team" data-section="team">
      ...
      members={[
        ...
        },
        {
          ...
          name: "Elena Rossi",
          role: "Sous Chef",
          imageSrc: "http://img.b2bpic.net/free-photo/shot-beautiful-female-chef-smiling-joyfully-while-working-her-kitchen-cutting-grilled-meat-with-scissors_7502-5549.jpg",
        },
        {
          id: "m3",
          name: "Marcus Thorne",
      ...
      faqs={[
        {
          ...
          content: "Yes, we highly recommend booking in advance to ensure your preferred dining time.",
        },
        {
          id: "q2",
          title: "Is there a dress code?",
          content: "Smart-casual attire is preferred to match the elegant atmosphere of our dining room.",
        },
        {
          id: "q3",
          title: "Are dietary restrictions accommodated?",
          content: "Our kitchen is happy to prepare alternative options for most dietary requirements with prior notice.",
        },
      ]}
